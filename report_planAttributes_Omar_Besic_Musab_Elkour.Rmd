...
### Grafische Darstellung des moop in den USA (Interactive Map)
...
SBC = Zusammenfassung der Leistungen und Deckung. Liefert klare und konsistente Informationen, um zu verstehen, was abgedeckt ist und was es kostet.
...
### Verteilung der Deckungskosten der Mitversicheung für Diabetes in den USA (Für das Jahr 2014)
Wir generieren ein Barplot und ein Histogramm. Merken aber, dass beide Diagramme durch die zu vielen 0 Werte verzerrt wird.
...
### Grafische Darstellung der Deckungskosten der Mitversicherung in den USA für das Jahr 2014 (Interactive Map)
Nun zeigen wir die Verteilung der Deckungskosten auf die verschiedenen US Bundesstaaten verteilt
