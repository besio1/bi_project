...
Hier haben wir die Liste aller StateCodes sowie die max out of pocket je Staat aufgelistet und zusammengefasst. Dies wird benötigt für die MAP Darstellung 
```{r,include=FALSE, echo=FALSE}
